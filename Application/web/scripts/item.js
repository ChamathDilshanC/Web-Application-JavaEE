$(document).ready(function() {
    ...
    $('#saveItemBtn').click(function(e) {
        ...
        $.ajax({
            url: 'http://localhost:8080/Application/pages/item',
            method: 'POST',
            data: itemData,
    ...
    $('#updateItemBtn').click(function() {
        ...
        $.ajax({
            url: 'http://localhost:8080/Application/pages/item?' + itemData,
            type: 'PUT',
            success: function(response) {
    ...
    items.forEach(item => {
        ...
        $(`#deleteBtn-${item.id}`).click(function() {
            if (confirm('Are you sure you want to delete this item?')) {
                $.ajax({
                    url: 'http://localhost:8080/Application/pages/item?id=' + item.id,
                    type: 'DELETE',
                    success: function(response) {
