$(document).ready(function() {
    ...
    $('#saveCustomerBtn').click(function(e) {
        ...
        $.ajax({
            url: 'http://localhost:8080/Application/pages/customer',
            method: 'POST',
            data: customerData,
    ...
    $('#updateCustomerBtn').click(function() {
        ...
        $.ajax({
            url: 'http://localhost:8080/Application/pages/customer?' + customerData,
            type: 'PUT',
            success: function(response) {
    ...
    customers.forEach(customer => {
        ...
        $(`#deleteBtn-${customer.id}`).click(function() {
            if (confirm('Are you sure you want to delete this customer?')) {
                $.ajax({
                    url: 'http://localhost:8080/Application/pages/customer?id=' + customer.id,
                    type: 'DELETE',
                    success: function(response) {
